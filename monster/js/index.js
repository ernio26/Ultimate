function App() {
  ...
  function initScene() {
    ...
    loader.load('https://www.iutbayonne.univ-pau.fr/~klevron/test/misc/buildings.fbx', object => {
...
function Appp() {
  ...
  function initt() {
    renderer = new WebGLRenderer({ canvas: document.getElementById(confi.el), antialias: true, alpha: true });
    camera = new PerspectiveCamera(confi.fov);
    camera.position.z = confi.cameraZ;
